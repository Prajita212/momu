...
function Testimonial() {
  ...
  return (
    <div className="lg:w-350 mx-auto bg-[#F9F7F7] px-4 py-16 relative z-0 overflow-hidden lg:overflow-visible mb-10 lg:px-20">
      ...
      >
        {testimonials.map((testimonial) => (
          <SwiperSlide key={testimonial.id} className="overflow-hidden !flex justify-center">
            <div className="relative border border-gray-200 rounded-xl p-6 pt-16 h-90 w-80 shadow-sm hover:shadow-md transition-shadow bg-white overflow-visible">
              ...
              <div className="text-center mt-4">
                ...
                <h4 className="font-medium text-lg text-gray-900 mb-3">{testimonial.title}</h4>
                <p className="text-gray-600 mb-4">"{testimonial.quote}"</p>
              </div>

              <div className="mt-8 flex justify-end items-end gap-2">
                <div className="text-right">
                  <h3 className="font-semibold text-sm text-gray-800">{testimonial.name}</h3>
